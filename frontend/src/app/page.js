...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center px-4">
      <div className="max-w-4xl w-full text-center">
        <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-12 border border-white/20">
          <div className="inline-block p-4 bg-linear-to-br from-indigo-500 to-purple-600 rounded-3xl mb-6">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-linear-to-br from-blue-50 to-indigo-50 rounded-2xl">
            ...
            <div className="p-6 bg-linear-to-br from-pink-50 to-red-50 rounded-2xl">
